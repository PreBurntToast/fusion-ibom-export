...
- [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom)
  installed for a **standalone Python on your system PATH** — not
  Fusion's own bundled Python. Fusion embeds Python inside its own
  process rather than launching a separate `python.exe`, so there's
  nothing to install into there, and even if there were, Fusion replaces
  its entire bundled-Python folder on every update anyway.
  ...
  Both the script and the add-in will tell you this exact command if
  they can't find InteractiveHtmlBom. (Thanks to
  [Funkenjaeger](https://github.com/Funkenjaeger) for catching and
  diagnosing this.)
